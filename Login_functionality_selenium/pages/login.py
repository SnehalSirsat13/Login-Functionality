...
class Login_page:
    username_text_filed_xpath_by_name = "email"
    password_text_filed_xpath_by_name = "password"
    login_btn_xpath_by_name = "Login"
    def __init__(self,driver):
        self.driver=driver
    def setUsername(self,username):
        self.driver.find_element(By.NAME,self.email_text_filed_xpath_by_name).clear()
        self.driver.find_element(By.NAME,self.email_text_filed_xpath_by_name).send_keys(username)
